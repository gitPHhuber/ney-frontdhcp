import type { DeviceHistoryEntry, ProductPassport } from '../../entities';
import type { TemplateFieldValue } from '../workspace/types';
...
export const buildExportRows = (passport: ProductPassport, history: DeviceHistoryEntry[]) => {
