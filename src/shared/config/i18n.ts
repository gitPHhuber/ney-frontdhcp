  ...
  ru: {
    translation: {
      ...
      dashboard: {
        ...
        metricsDescription: 'Следите за нагрузкой и всплесками аренд в режиме, близком к реальному времени.',
      ...
      alerts: {
        ...
        streamDescription: 'Критические (P1-P2) оповещения выводятся всплывающими окнами; остальные накапливаются здесь.',
        samples: {
      ...
      navigationCheckPage: {
        ...
        description:
          'Убедитесь, что все ленивые маршруты подгружаются без ошибок и фиксируйте матрицу ОК/FAIL для релиз-нот.',
        lastRun: 'Последний запуск: {{timestamp}}',
        runCheck: 'Запустить проверку',
        checking: 'Проверка…',
        summary: {
          healthy: 'Маршрутов ОК',
        ...
        emptyState:
          'Запустите проверку, чтобы заполнить матрицу ОК/FAIL для всех маршрутов оболочки.',
        status: {
          ok: 'ОК',
          fail: 'Ошибка',
        },
